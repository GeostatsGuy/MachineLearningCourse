---
title: 'PGE 383 Project: Bayesian LASSO Regression Using Rstudio'
author: "Shaikha Aldossary"
date: "2023-11-23"
...
print(lasso_coef)       #This code is used to display the coefficients of the LASSO regression model stored in the lasso_coef variable.
...
print(lasso_coef_numeric)     #This will display the numeric vector containing the coefficients obtained from the LASSO regression model. The output would look like a simple numeric vector with the values of the coefficients.
```
